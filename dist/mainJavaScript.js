...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Player: () => (/* binding */ Player)\n/* harmony export */ });\n/* harmony import */ var _classGameBoard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./classGameBoard */ \"./src/classGameBoard.js\");\n/* harmony import */ var _classShip__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./classShip */ \"./src/classShip.js\");\n\n\n\n\nclass Player {\n  constructor() {\n    this.humanPlayerGameBoard = new _classGameBoard__WEBPACK_IMPORTED_MODULE_0__.Gameboard();\n    this.aiPlayerGameBoard = new _classGameBoard__WEBPACK_IMPORTED_MODULE_0__.Gameboard();\n  }\n\n  humanPlayerCurrentGameBoard() {\n    return this.humanPlayerGameBoard.gameBoardStatus();\n  }\n\n  humanPlayerInitialPlacement(ship, rowCords, columnCords) {\n    this.humanPlayerGameBoard.placeShips(ship, rowCords, columnCords);\n  }\n\n  aiPlayerCurrentGameBoard() {\n    return this.aiPlayerGameBoard.gameBoardStatus();\n  }\n\n  getRndInteger(min, max) {\n    return Math.floor(Math.random() * (max - min)) + min;\n  }\n\n  aiPlayerInitialRandomShipPlacement() {\n    this.newShipAAi = new _classShip__WEBPACK_IMPORTED_MODULE_1__.Ship(\"Ship AAi\", this.getRndInteger(1, 5));\n    this.newShipBAi = new _classShip__WEBPACK_IMPORTED_MODULE_1__.Ship(\"Ship BAi\", this.getRndInteger(1, 5));\n    this.newShipCAi = new _classShip__WEBPACK_IMPORTED_MODULE_1__.Ship(\"Ship CAi\", this.getRndInteger(1, 5));\n    this.newShipDAi = new _classShip__WEBPACK_IMPORTED_MODULE_1__.Ship(\"Ship DAi\", this.getRndInteger(1, 5));\n    this.newShipEAi = new _classShip__WEBPACK_IMPORTED_MODULE_1__.Ship(\"Ship EAi\", this.getRndInteger(1, 5));\n    this.newShipFAi = new _classShip__WEBPACK_IMPORTED_MODULE_1__.Ship(\"Ship FAi\", this.getRndInteger(1, 5));\n    this.newShipGAi = new _classShip__WEBPACK_IMPORTED_MODULE_1__.Ship(\"Ship GAi\", this.getRndInteger(1, 5));\n    this.newShipHAi = new _classShip__WEBPACK_IMPORTED_MODULE_1__.Ship(\"Ship HAi\", this.getRndInteger(1, 5));\n    this.newShipIAi = new _classShip__WEBPACK_IMPORTED_MODULE_1__.Ship(\"Ship IAi\", this.getRndInteger(1, 5));\n    this.newShipJAi = new _classShip__WEBPACK_IMPORTED_MODULE_1__.Ship(\"Ship JAi\", this.getRndInteger(1, 5));\n\n    this.aiPlayerGameBoard.placeShips(\n      this.newShipAAi,\n      \"A\",\n      this.getRndInteger(0, 6)\n    );\n    this.aiPlayerGameBoard.placeShips(\n      this.newShipBAi,\n      \"B\",\n      this.getRndInteger(0, 6)\n    );\n    this.aiPlayerGameBoard.placeShips(\n      this.newShipCAi,\n      \"C\",\n      this.getRndInteger(0, 6)\n    );\n    this.aiPlayerGameBoard.placeShips(\n      this.newShipDAi,\n      \"D\",\n      this.getRndInteger(0, 6)\n    );\n    this.aiPlayerGameBoard.placeShips(\n      this.newShipEAi,\n      \"E\",\n      this.getRndInteger(0, 6)\n    );\n    this.aiPlayerGameBoard.placeShips(\n      this.newShipFAi,\n      \"F\",\n      this.getRndInteger(0, 6)\n    );\n    this.aiPlayerGameBoard.placeShips(\n      this.newShipGAi,\n      \"G\",\n      this.getRndInteger(0, 6)\n    );\n    this.aiPlayerGameBoard.placeShips(\n      this.newShipHAi,\n      \"H\",\n      this.getRndInteger(0, 6)\n    );\n    this.aiPlayerGameBoard.placeShips(\n      this.newShipIAi,\n      \"I\",\n      this.getRndInteger(0, 6)\n    );\n    this.aiPlayerGameBoard.placeShips(\n      this.newShipJAi,\n      \"J\",\n      this.getRndInteger(0, 6)\n    );\n\n    console.log(this.newShipAAi);\n    console.log(this.newShipJAi);\n    console.log(this.aiPlayerCurrentGameBoard());\n  }\n}\n\n\n//# sourceURL=webpack://BattleShip_game_Development_using_TDD/./src/classPlayers.js?");
